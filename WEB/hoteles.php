	...
	<body>
		<table>
			<tr>
				...
				<td><input type="radio" onclick="addHotel(this)" name="hotel" value="<?php echo $hotel['nombre']; ?>" id="hotel" checked="true"></td>
			</tr>
			<tr>
				<?php $hotel = mysql_fetch_assoc($arrayHoteles); ?>
				<th><?php echo $hotel['nombre']; ?></th>
				<td><img style="width: 150px;height: 100px" src="<?php echo $hotel['foto']; ?>"/></td>
				<td><?php echo $hotel['precio']; ?>&euro;</td>
				<td><input type="radio" onclick="addHotel(this)" name="hotel" value="<?php echo $hotel['nombre']; ?>" id="hotel"></td>
			</tr>
			<tr>
				<?php $hotel = mysql_fetch_assoc($arrayHoteles); ?>
				<th><?php echo $hotel['nombre']; ?></th>
			...
			<tr>
				...
				<td>Ninguno</td>
				<td></td>
				<td><input type="radio" onclick="addHotel(this)" name="hotel" value="no" id="hotel"></td>
			</tr>
