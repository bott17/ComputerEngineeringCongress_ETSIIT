...
<div class='mainContent'>
	...
	<?php
		for($contador = 0; $contador < mysql_num_rows($arrayCongresistas); $contador++) {
			...
			echo 
				"<div class='actividad'>
					<h3><span>Nombre: " .$congresista["Nombre"]. " " .$congresista["Apellidos"]."</span><br>
					...
					<span>Tipo de inscripcion: " .$congresista["idCuota"]. " Con precio de: " .$congresista["importe"]. "€</span></h3><br>
				</div>";
		}
	?>
</div>
