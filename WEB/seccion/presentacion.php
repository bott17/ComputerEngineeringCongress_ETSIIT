<div class='mainContent'>
	...
	<p>
		...
		o <strong>ETSIIT</strong> durante los d&iacute;as <strong>1, 2 y 3 de junio</strong>.
		<br>
		<br>
		...
		con la festividad del <strong>Corpus</strong>!!!
		<br>
		<br>
		Al congreso te puedes inscribir gratuitamente, pero si quieres asistir tendr&aacute;s que abonar el precio de la entrada
		correspondiente . Hay descuento para la compra anticipada (mas informaci&oacute;n en la secci&oacute;n <strong> Inscr&iacute;bete</strong>).
	</p>
	...
	<p>
		...
		es la sexta a nivel europeo.
		<br>
		<br>
		Se encuentra en el Campus Universitario de Aynadamar, junto a la Facultad de Bellas Artes y al Centro de
		Investigación en Tecnologías de la Información y la comunicación de la UGR (CITIC-UGR).
		<br>
		<br>
		En ella se imparten las siguientes titulaciones:
		<br>
	...
	<p>
		...
		península ibérica, Sierra Nevada, que condiciona su clima.
		<br>
		<br>
		...
		populares por los universitarios europeos del programa Erasmus.
		<br>
		<br>
		...
		<strong>Llegar a Granada en tren</strong>
		<br>
		<br>
		...
		las personas prefieren viajar en autobús en vez de tren cuando vienen desde Málaga o Almería.
		<br>
		<br>

		<strong>Llegar a Granada en Autobús</strong>
		<br>
		<br>
		...
		También se puede coger un autobús (Nº 3 ó 33) para llegar al centro.
		<br>
		<br>

		Ejemplo llegar desde Madrid
		<br>
